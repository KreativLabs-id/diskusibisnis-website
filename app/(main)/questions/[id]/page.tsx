        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6 mb-6 shadow-sm">
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
            ...
            <div className="flex items-center gap-2 sm:flex-col sm:gap-1">
              <span className="text-xl sm:text-2xl font-bold text-gray-900">{question.upvotes_count || 0}</span>
          ...
          {question.answers?.map((answer) => (
            ...
            >
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-6">
                ...
                <div className="flex items-center gap-2 sm:flex-col sm:gap-1">
                  <span className="text-lg sm:text-xl font-bold text-gray-900">{answer.upvotes_count || 0}</span>
                  <span className="text-xs text-slate-500 sm:hidden">votes</span>
                </div>
                <button
