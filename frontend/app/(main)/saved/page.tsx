                        ...
                        {bookmarks.map((question) => (
                            <div key={question.id} className="relative group/bookmark">
                                ...
                                <button
                                    ...
                                    className="absolute top-4 right-4 p-2 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-slate-200 dark:border-slate-700 text-slate-400 dark:text-slate-500 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors shrink-0 z-10 opacity-0 group-hover/bookmark:opacity-100 shadow-sm"
