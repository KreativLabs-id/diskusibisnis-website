    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-200">
      <div className="max-w-3xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="space-y-16">
          ...
          {/* FAQ Section */}
          <section>
            <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-8">Pertanyaan Umum (FAQ)</h2>
            <div className="space-y-6">

              <div className="group">
                <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">Bagaimana cara menaikkan Reputasi?</h3>
              ...
              <div className="group">
                <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">Apakah platform ini gratis?</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              ...
              <div className="group">
                <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">Bagaimana cara melaporkan konten spam?</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
