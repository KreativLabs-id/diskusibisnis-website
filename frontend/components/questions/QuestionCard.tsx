...
export default function QuestionCard({ question, onReport, currentUserId }: QuestionCardProps) {
  ...
  return (
    <div 
      className="group relative bg-white/60 dark:bg-slate-900/40 backdrop-blur-md border border-white dark:border-slate-800/60 rounded-[1.5rem] sm:rounded-[2rem] p-5 sm:p-8 hover:bg-white dark:hover:bg-slate-800 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-500/5 cursor-pointer overflow-hidden"
      onClick={() => {
